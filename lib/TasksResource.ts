...
export default class TasksResource {
    ...
    async get(
        ...
        const response = await this.docSDK.axios.get('tasks/' + id, {
            params: query || {}
        });
    ...
    async wait(id: string): Promise<Task> {
        const response = await this.docSDK.axios.get(
            'tasks/' + id + '/wait'
        );
        return response.data.data;
    }
    ...
    async all(
        ...
        const response = await this.docSDK.axios.get('tasks', {
            params: query || {}
        });
        return response.data.data;
    }
    ...
    async create<O extends Operation['operation']>(
        ...
        const response = await this.docSDK.axios.post(operation, data);
        return response.data.data;
    }

    async delete(id: string): Promise<void> {
        await this.docSDK.axios.delete('tasks/' + id);
    }
    ...
    async upload(
        ...
        return await this.docSDK.axios.post(
