...
export default class JobsResource {
    ...
    async get(id: string, query = null): Promise<Job> {
        const response = await this.docSDK.axios.get('jobs/' + id, {
            params: query || {}
        });
    ...
    async all(
        ...
        const response = await this.docSDK.axios.get('jobs', {
            params: query || {}
        });
        return response.data.data;
    }
    ...
    async create(data: JobTemplate | null = null): Promise<Job> {
        const response = await this.docSDK.axios.post('jobs', data);
        return response.data.data;
    }

    async delete(id: string): Promise<void> {
        await this.docSDK.axios.delete('jobs/' + id);
    }
