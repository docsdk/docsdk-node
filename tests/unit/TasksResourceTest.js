...
describe('TasksResource', () => {
    ...
    describe('all()', () => {
        it('should fetch all tasks', async () => {
            ...
            const data = await this.docSDK.tasks.all();
    ...
    describe('get()', () => {
        it('should fetch a task by id', async () => {
            ...
            const data = await this.docSDK.tasks.get(
    ...
    describe('create()', () => {
        it('should send the create request', async () => {
            ...
            const data = await this.docSDK.tasks.create('convert', {
                name: 'test',
                url: 'http://invalid.url',
                filename: 'test.file'
            });
    ...
    describe('delete()', () => {
        it('should send the delete request', async () => {
            ...
            await this.docSDK.tasks.delete(
    ...
    describe('upload()', () => {
        it('should send the upload request', async () => {
            ...
            const task = await this.docSDK.tasks.create('import/upload');

            nock('https://upload.sandbox.docsdk.com', {
                reqheaders: {
                    'Content-Type': /multipart\/form-data/i
                }
            })
                .post(
                    '/storage.de1.cloud.ovh.net/v1/AUTH_b2cffe8f45324c2bba39e8db1aedb58f/docsdk-files-sandbox/8aefdb39-34c8-4c7a-9f2e-1751686d615e/?s=jNf7hn3zox1iZfZY6NirNA&e=1559588529'
                )
                .reply(201);
